...
from app.models.enums import FileStatus, DocumentType, DocumentCategory
        ...
        try:
            ...
            if metadata_result["success"]:
                ...
                await self._update_file_status(
                    file_id, 
                    FileStatus.AI_FAILED,
                    error_message=metadata_result["error"]
                )
                return {
                    "success": False,
                    "file_id": file_id,
...
"""
    ...
    async def _extract_with_anthropic(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Anthropic API failed: {str(e)}"
            }
